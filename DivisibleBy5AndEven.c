//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  Name Of Program:-  DivisibleBy5AndEven
//  Input:-            85 66 3 80 93 88
//  Output:-           80
//  Input:-            5 10 2 6 8
//  Output:-           10            
//  Discription:-      Accept n number from user and display all such elements which are divisible by 5 and even.
...
void DivisibleBy5Array(int arr[],int iLength)
{
    ...
    int iCnt=0;
    printf("Number Divisible by 5 and Even are \n");
