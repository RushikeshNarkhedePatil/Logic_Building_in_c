//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  Name Of Program:-  ReturnFirstOccurence
//  Input:-            5
//  Element            10,11,15,14,8
//  Value              11
//  Output:-           1          
//  Discription:-      Accept No fro user as well as accept one No and return the first occurence of that number.
...
int ReturnFirstOccurence(int no,int arr[],int iLength)
{
...
int main()
{
    ...
    scanf("%d",&iValue);
    iRet=ReturnFirstOccurence(iValue,brr,isize);
    if(iRet==-1)
    {
